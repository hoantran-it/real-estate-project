		...
		<div class="row">
            ...
            <div class="col-lg-7 col-sm-7 col-xs-12 pull-left">
				...
				<div class="product-detail thumbnail clearfix">
					<img src="public/upload/product/<?php echo $information['picture'];?>"
						alt="" class="col-sm-4" />

					<div class="col-sm-8">
						<h3 class="title"><?php echo $information['title']; ?></h3>
						<p class="information-text"><?php echo $information['description']; ?></p>
					</div>
				</div>
				<!-- END CONTENT -->
			</div>
